...
# Each device has: label, topic (MQTT), icon (glyph), on state (initial state)
DEVICES_CONFIG = [
	{"label": "Washing Machine", "topic": "statechange/washing_machine", "icon": "\ue832", "on": False},
	{"label": "Dryer", "topic": "statechange/dryer", "icon": "\ue54a", "on": False},
	{"label": "Engine Heater", "topic": "statechange/engine_heater", "icon": "\ue531", "on": False},
	{"label": "Bike Charger", "topic": "statechange/bike_charger", "icon": "\ueb1b", "on": False},
]
...
WEATHER_LANG = "en"  # English language for weather descriptions
